...
const de: Record<string, string> = {
  ...
  'acc.benefits_toggle': 'Was bringt mir das?',
  'acc.benefit_backup_t': 'Online gesichert',
  'acc.benefit_backup_d': 'Deine Spiele & Trainings liegen sicher in der Cloud – kein Verlust beim Gerätewechsel.',
  'acc.benefit_sync_t': 'Geräteübergreifend',
  'acc.benefit_sync_d': 'Unter „Dein Konto" werden deine Daten zwischen deinen Geräten synchronisiert.',
  'acc.benefit_group_t': 'Gemeinsam in Trainingsgruppen',
  'acc.benefit_group_d': 'Alle Mitglieder einer Gruppe teilen ihre Daten miteinander.',
  'acc.welcome_title': 'Geschafft – du bist angemeldet! 🎉',
  'acc.welcome_body': '„Dein Konto" findest du ab jetzt oben über die Kontoauswahl. Damit ist freigeschaltet:',
  'acc.welcome_b1': 'Deine Daten sind online gesichert und werden zwischen deinen Geräten synchronisiert.',
  'acc.welcome_b2': 'Du kannst Trainingsgruppen anlegen oder per Code beitreten – dann teilen alle Mitglieder ihre Daten innerhalb der Gruppe.',
  'acc.welcome_cta': 'Los geht\'s',
  'gm.copy': 'Code kopieren', 'gm.copied': 'Kopiert',
  ...
  'acc.create_group': 'Trainingsgruppe anlegen', 'acc.create_name_ph': 'Name der Gruppe', 'acc.create_btn': 'Anlegen',
  'acc.create_pricing': 'Trainingsgruppen sind bis auf Weiteres kostenlos. Sollte es zur Deckung der Infrastrukturkosten nötig werden, kann diese Funktion künftig kostenpflichtig werden. Selbst dann bleibt der lesende Zugriff auf bereits vorhandene Daten kostenlos.',
  'acc.create_failed': 'Anlegen fehlgeschlagen.', 'acc.create_limit': 'Du kannst höchstens 3 Gruppen besitzen.',
...
const en: Record<string, string> = {
  ...
  'acc.benefits_toggle': 'What do I get?',
  'acc.benefit_backup_t': 'Backed up online',
  'acc.benefit_backup_d': 'Your matches & trainings are safe in the cloud – no loss when switching devices.',
  'acc.benefit_sync_t': 'Across devices',
  'acc.benefit_sync_d': 'Under “Your account”, your data syncs across your devices.',
  'acc.benefit_group_t': 'Together in training groups',
  'acc.benefit_group_d': 'All members of a group share their data with each other.',
  'acc.welcome_title': 'Done – you\'re signed in! 🎉',
  'acc.welcome_body': '“Your account” is now available up top via the account switcher. Unlocked:',
  'acc.welcome_b1': 'Your data is backed up online and synced across your devices.',
  'acc.welcome_b2': 'You can create training groups or join one with a code – then all members share their data within the group.',
  'acc.welcome_cta': 'Let\'s go',
  'gm.copy': 'Copy code', 'gm.copied': 'Copied',
  ...
  'acc.create_group': 'Create training group', 'acc.create_name_ph': 'Group name', 'acc.create_btn': 'Create',
  'acc.create_pricing': 'Training groups are free for now. Should it become necessary to cover infrastructure costs, this feature may become paid in the future. Even then, read access to already-existing data will remain free.',
  'acc.create_failed': 'Could not create the group.', 'acc.create_limit': 'You can own at most 3 groups.',
